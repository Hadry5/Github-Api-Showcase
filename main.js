...
function showUserData(userData) {
    let userContent = `
        ...
        <section class="data">
            <ul>
                <li>Followers: ${ userData.followers} Followers</li>
    ...
    userContent += `
    <section class="code">
        <a href="${userData.url}" target="_blank">Access JSON from Github Api</a>
    </section>
    <p>Developed by Adrian Lozano Carretero & Jaime Rodriguez de Vera Martinez</p>  
    `
